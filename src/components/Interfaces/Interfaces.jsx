...
import { DiccionarioInterface } from "./interface";
...
const Interfaces = () => {
  return (
    <>
      <MisProyectos id="ui">Diseño UI</MisProyectos>
      {DiccionarioInterface.map((proyecto) => {
        return (
